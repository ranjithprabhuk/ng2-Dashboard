...
@Component({
    selector:'dashboard',
    templateUrl:'app/modules/dashboard/components/dashboard/view/dashboard.html',
})
...
export class DashBoardComponent {
   ...
   */
        ...
        */
       public pushMenu :any = {
            activate: function (toggleBtn:any,options:any) {
            ...
            expandOnHover: function (options:any) {
            var _this = this;
            var _options = options;
       ...
       public controlSidebar:any = {
            ...
            open: function (sidebar:any, slide:any) {
            //Slide over content
            if (slide) {
            ...
            close: function (sidebar:any, slide:any) {
            if (slide) {
            ...
            _fixForFixed: function (sidebar:any) {
            sidebar.css({
                'position': 'fixed',
                'max-height': '100%',
                'overflow': 'auto',
            ...
            _fixForContent: function (sidebar:any) {

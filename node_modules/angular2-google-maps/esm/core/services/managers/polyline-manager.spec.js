...
describe('PolylineManager', () => {
    ...
    describe('Create a new polyline', () => {
        it('should call the mapsApiWrapper when creating a new polyline', inject([PolylineManager, GoogleMapsAPIWrapper], (polylineManager, apiWrapper) => {
    ...
    describe('Delete a polyline', () => {
        it('should set the map to null when deleting a existing polyline', inject([PolylineManager, GoogleMapsAPIWrapper], (polylineManager, apiWrapper) => {
            const newPolyline = new SebmGoogleMapPolyline(polylineManager);
            const polylineInstance = jasmine.createSpyObj('Polyline', ['setMap']);
